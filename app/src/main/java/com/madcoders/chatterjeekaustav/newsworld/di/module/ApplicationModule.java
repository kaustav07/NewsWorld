...
import com.madcoders.chatterjeekaustav.newsworld.data.model.DaoMaster;
import com.madcoders.chatterjeekaustav.newsworld.data.model.DaoSession;
import com.madcoders.chatterjeekaustav.newsworld.di.ApplicationContext;
...
public class ApplicationModule {
    ...
    DaoSession provideDaoSession(){
        DaoMaster.DevOpenHelper helper = new DaoMaster.DevOpenHelper(mApplication, Constants.DATABASE_NAME);
